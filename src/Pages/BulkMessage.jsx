...
// //       console.log("contactList", formatted);
// //       console.log("contactNumbers", allNumbers);
// //     }
// //   };
...
// // // Include media URL only if applicable
// // if (
// //   headerMediaFile &&
// //   selectedTemplate.components.some(comp => comp.type === "HEADER")
// // ) {
// //   const mediaUrl = URL.createObjectURL(headerMediaFile); // Only temporary, better to upload to cloud first
// //   payload.header_type = selectedTemplate.components.find(c => c.type === "HEADER")?.format?.toLowerCase();
// //   payload.media_url = mediaUrl;
// // }

// // await BulkMessageAPI(user_id, payload);
...
// //                 className="w-full h-[100px] border border-gray-300 rounded px-3 py-2 resize-none focus:outline-none focus:border-[#905CC1] focus:ring-1 focus:ring-[#905CC1] bg-gray-50"
// //               />
// //             )}
...
// //               </select>
// //             </div>
// //            {templatelist[selectedIndex]?.components
// //   .filter((comp) => comp.type === "HEADER")
// //   .map((comp, compIndex) => {
// //     const matches = comp.text?.match(/{{\d+}}/g) || [];
// //     const format = (comp.format || "").toLowerCase();
// //     const isHeaderMedia = ["image", "video", "document"].includes(format);

// //     return (
// //       <div key={compIndex} className="p-4 bg-white border rounded-xl">
...
export default function BulkMessage() {
  ...
  const Handlee = async () => {
    ...
    if (
      ...
      payload.header_type = selectedTemplate.components

...
export default function App() {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-5 min-h-screen bg-gray-100 p-4">
      {/* Left Sidebar */}
      <div className="w-full lg:w-[250px] bg-white border border-gray-300 p-4 rounded-2xl shadow-md flex flex-col justify-between">
        <div>
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-xl font-bold text-gray-800">Chat Weight</h2>
            <div className="flex gap-1 items-center px-2 py-1 border border-gray-300 rounded-lg">
      ...
      <div className="flex-1 bg-white p-6 rounded-2xl shadow-md">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl md:text-3xl font-bold text-gray-800">General</h1>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <Inputs
              ...
              value={keyword}
              onChange={(e) => setKeyword(e)}
              inputClassName="w-full md:w-[500px] h-[50px] mt-1 rounded-2xl bg-gray-200 border-none focus:outline-none focus:ring-0 focus:border-none"
            />
          </div>
          ...
          <div>
            ...
            <Inputs
              ...
              value={replay}
              onChange={(e) => setReplay(e)}
              inputClassName="w-full md:w-[500px] h-[70px] mt-1 rounded-2xl bg-gray-200 border-none focus:outline-none focus:ring-0 focus:border-none"
            />
          </div>

          {/* Fallback Message */}
          <div>
            <p className="font-medium text-gray-800 mb-1">Fallback Message</p>
            <Inputs
              type="text"
          ...
          {/* Bot Avatar */}
          <div>
            <h2 className="font-medium text-gray-800 mb-2">Bot Avatar</h2>
            <Inputs
              type="file"
              placeholder="Upload Avatar"
              inputClassName="w-full h-16 rounded-2xl pl-3 bg-white text-gray-700 border-none focus:outline-none bg-gray-200
              file:bg-gray-200 file:text-violet-700 file:rounded-lg file:px-7 file:py-2 file:gap-3 
              file:border-0 file:font-medium file:cursor-pointer"
              onChange={(file) => {
                console.log(file);
          ...
          <button
            className="w-full bg-violet-600 hover:bg-violet-700 text-white font-semibold py-3 rounded-2xl transition duration-300"
            onClick={HandleChatBot}
          >
            Chat With Us
          </button>
      ...
      {/* Right Sidebar */}
      <div
        className="w-full lg:w-[300px] h-auto bg-amber-200 p-6 rounded-2xl shadow-md flex flex-col  mt-5 lg:mt-0"
        style={{
          backgroundImage:
            "linear-gradient(to bottom, #E0BCFF 0px, #F8F8F8 120px, #F8F8F8 100%)",
          backgroundRepeat: "no-repeat",
          backgroundSize: "cover",
          backgroundPosition: "center",
        }}
      >
        ...
        <div className="bg-white rounded-2xl p-4 shadow-md w-full h-auto flex flex-col md:flex-row md:items-center gap-4">
          <img
            src={person}
            alt="Person"
            className="h-[60px] w-[60px] rounded-full object-cover"
